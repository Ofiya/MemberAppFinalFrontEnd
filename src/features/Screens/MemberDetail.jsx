...
const MemberDetail = ({editedMember, onClose, openMessage, closeMessage, updateSeccessMessage, updateError}) => {
    ...
    const [delMemberOpen, setDelMemberOpen] = useState(false);
    const closeDelModal = () => setDelMemberOpen(false)
    ...
    return (
        ...
        <div id="members-page" className="page p-6">
                ...
                <form onSubmit={handleSubmit}  className="bg-white rounded-lg shadow-lg w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
                    ...
                    <div  className="p-6">
                        ...
                        <div className="flex justify-end space-x-3 mt-6">
                            <button type="button" onClick={() => setDelMemberOpen(true) } id="delete-member"  className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700">
                                Delete Member
                            </button>
            ...
            <AppDialog
                isOpen={delMemberOpen}
                onClose={() => setDelMemberOpen(false)}
            >

                <DeleteMemberModal
                    firstName={formData.name?.first_name}
                    lastName={formData.name?.last_name}
                    memberId={uuid}
                    closeDelMember={closeDelModal}
